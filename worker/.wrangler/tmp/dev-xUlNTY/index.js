...
// .wrangler/tmp/bundle-5gWM2w/checked-fetch.js
...
// .wrangler/tmp/bundle-5gWM2w/strip-cf-connecting-ip-header.js
...
var src_default = {
  ...
  async fetch(request, env, ctx) {
    ...
    try {
      ...
      if (path === "/health") {
        return json6({ status: "ok", ts: Date.now() });
      }
      return notFound();
    } catch (err) {
      console.error("[worker] unhandled error:", err);
      return json6({ error: "Internal server error", detail: err.message }, 500);
    }
  },
...
// .wrangler/tmp/bundle-5gWM2w/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-5gWM2w/middleware-loader.entry.ts
